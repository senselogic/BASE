...
struct REAL_32_MATRIX_9
{
        ...
        )
    {
        ...
        XVector.X = cosinus + ( 1.0f - cosinus ) * axis_vector.X;
        XVector.Y = ( 1.0f - cosinus ) * axis_vector.X * axis_vector.Y + sinus * axis_vector.Z;
        XVector.Z = ( 1.0f - cosinus ) * axis_vector.X * axis_vector.Z - sinus * axis_vector.Y;

        YVector.X = ( 1.0f - cosinus ) * axis_vector.Y * axis_vector.X - sinus * axis_vector.Z;
        YVector.Y = cosinus + ( 1.0f - cosinus ) * axis_vector.Y * axis_vector.Y;
        YVector.Z = ( 1.0f - cosinus ) * axis_vector.Y * axis_vector.Z + sinus * axis_vector.X;

        ZVector.X = ( 1.0f - cosinus ) * axis_vector.Z * axis_vector.X + sinus * axis_vector.Y;
        ZVector.Y = ( 1.0f - cosinus ) * axis_vector.Z * axis_vector.Z - sinus * axis_vector.X;
        ZVector.Z = cosinus + ( 1.0f - cosinus ) * axis_vector.Z * axis_vector.Z;
    }

    // ~~

    VOID SetProductMatrix(
        const REAL_32_MATRIX_9 & first_matrix,
        const REAL_32_MATRIX_9 & second_matrix
        )
    {
