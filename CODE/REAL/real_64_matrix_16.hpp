...
#include "real_64_vector_4.hpp"
#include "streamed_output.hpp"
#include "void.hpp"

// ~~

struct REAL_64_MATRIX_9;
struct REAL_64_MATRIX_12;
...
struct REAL_64_MATRIX_16
{
    ...
    REAL_64_MATRIX_16(
        const REAL_64_VECTOR_4 & x_vector,
        const REAL_64_VECTOR_4 & y_vector,
        const REAL_64_VECTOR_4 & z_vector,
        const REAL_64_VECTOR_4 & w_vector
        ) :
        XVector( x_vector ),
        YVector( y_vector ),
        ZVector( z_vector ),
    ...
    {
        return
            REAL_64_IsRoughlyOne( XVector.X )
            && REAL_64_IsRoughlyZero( XVector.Y )
            && REAL_64_IsRoughlyZero( XVector.Z )
            && REAL_64_IsRoughlyZero( XVector.W )
            && REAL_64_IsRoughlyZero( YVector.X )
            && REAL_64_IsRoughlyOne( YVector.Y )
            && REAL_64_IsRoughlyZero( YVector.Z )
            && REAL_64_IsRoughlyZero( YVector.W )
            && REAL_64_IsRoughlyZero( ZVector.X )
            && REAL_64_IsRoughlyZero( ZVector.Y )
            && REAL_64_IsRoughlyOne( ZVector.Z )
            && REAL_64_IsRoughlyZero( ZVector.W )
            && REAL_64_IsRoughlyZero( WVector.X )
            && REAL_64_IsRoughlyZero( WVector.Y )
            && REAL_64_IsRoughlyZero( WVector.Z )
            && REAL_64_IsRoughlyOne( WVector.W );
    }
        ...
        ) const
    {
        return
            this == &matrix
            || ( REAL_64_IsRoughlyEqual( XVector.X, matrix.XVector.X )
                 && REAL_64_IsRoughlyEqual( XVector.Y, matrix.XVector.Y )
                 && REAL_64_IsRoughlyEqual( XVector.Z, matrix.XVector.Z )
                 && REAL_64_IsRoughlyEqual( XVector.W, matrix.XVector.W )
                 && REAL_64_IsRoughlyEqual( YVector.X, matrix.YVector.X )
                 && REAL_64_IsRoughlyEqual( YVector.Y, matrix.YVector.Y )
                 && REAL_64_IsRoughlyEqual( YVector.Z, matrix.YVector.Z )
                 && REAL_64_IsRoughlyEqual( YVector.W, matrix.YVector.W )
                 && REAL_64_IsRoughlyEqual( ZVector.X, matrix.ZVector.X )
                 && REAL_64_IsRoughlyEqual( ZVector.Y, matrix.ZVector.Y )
                 && REAL_64_IsRoughlyEqual( ZVector.Z, matrix.ZVector.Z )
                 && REAL_64_IsRoughlyEqual( ZVector.W, matrix.ZVector.W )
                 && REAL_64_IsRoughlyEqual( WVector.X, matrix.WVector.X )
                 && REAL_64_IsRoughlyEqual( WVector.Y, matrix.WVector.Y )
                 && REAL_64_IsRoughlyEqual( WVector.Z, matrix.WVector.Z )
                 && REAL_64_IsRoughlyEqual( WVector.W, matrix.WVector.W )
                 );
    }
    ...
    const REAL_64_VECTOR_3 & GetXAxisVector(
        VOID
        ) const
    {
        DEBUG_Check( XVector.HasRoughlyUnitLength() );

        return *( const REAL_64_VECTOR_3 * ) &XVector;
    }

    // ~~

    const REAL_64_VECTOR_3 & GetYAxisVector(
        VOID
        ) const
    {
        DEBUG_Check( YVector.HasRoughlyUnitLength() );

        return *( const REAL_64_VECTOR_3 * ) &YVector;
    }

    // ~~

    const REAL_64_VECTOR_3 & GetZAxisVector(
        VOID
        ) const
    {
        DEBUG_Check( ZVector.HasRoughlyUnitLength() );

        return *( const REAL_64_VECTOR_3 * ) &ZVector;
    }
        ...
        ) const
    {
        ...
        one_over_w = 1.0 / ( vector.X * XVector.W + vector.Y * YVector.W + vector.Z * ZVector.W + WVector.W );
    ...
    VOID GetTransformedOriginVector(
        REAL_64_VECTOR_3 & transformed_origin_vector
        ) const
    {
        REAL_64
            one_over_w_divisor;

        one_over_w_divisor = 1.0 / WVector.W;
        ...
        )
    {
        ...
        z_axis_vector.GetXyzAxesFromZAxisVector(
            *( REAL_64_VECTOR_3 * ) &XVector,
            *( REAL_64_VECTOR_3 * ) &YVector,
            *( REAL_64_VECTOR_3 * ) &ZVector
            );
    }
    ...
    VOID SetFromScaling(
        const REAL_64_VECTOR_3 & scaling_vector
        )
    {
    ...
    VOID SetFromRotationAroundX(
        const REAL_64 x_cosinus,
        const REAL_64 x_sinus
        )
    {
        XVector.X = 1.0;
        XVector.Y = 0.0;
        ...
        )
    {
        SetFromRotationAroundX(
            REAL_64_GetCosinus( x_angle ),
            REAL_64_GetSinus( x_angle )
            );
    }
    ...
    VOID SetFromRotationAroundY(
        const REAL_64 y_cosinus,
        const REAL_64 y_sinus
        )
    {
        XVector.X = y_cosinus;
        XVector.Y = 0.0;
        ...
        )
    {
        SetFromRotationAroundY(
            REAL_64_GetCosinus( y_angle ),
            REAL_64_GetSinus( y_angle )
            );
    }
    ...
    VOID SetFromRotationAroundZ(
        const REAL_64 z_cosinus,
        const REAL_64 z_sinus
        )
    {
        XVector.X = z_cosinus;
        XVector.Y = z_sinus;
        ...
        )
    {
        SetFromRotationAroundZ(
            REAL_64_GetCosinus( z_angle ),
            REAL_64_GetSinus( z_angle )
            );
    }
        ...
        )
    {
        ...
        cosinus = REAL_64_GetCosinus( angle );
        sinus = REAL_64_GetSinus( angle );
        one_minus_cosinus = 1.0 - cosinus;
    ...
    {
        if ( !REAL_64_IsRoughlyOne( scaling_vector.X ) )
        {
            XVector.X *= scaling_vector.X;
        ...
        if ( !REAL_64_IsRoughlyOne( scaling_vector.Y ) )
        {
        ...
        if ( !REAL_64_IsRoughlyOne( scaling_vector.Z ) )
        {
    ...
    {
        DEBUG_Check( XVector.X != 0.0 );
        DEBUG_Check( YVector.Y != 0.0 );
        DEBUG_Check( ZVector.Z != 0.0 );
    ...
    VOID SetColumnVector(
        REAL_64_VECTOR_3 & column_vector,
    ...
    VOID SetXVector(
        const REAL_64_VECTOR_3 x_vector
        )
    {
    ...
    VOID SetYVector(
        const REAL_64_VECTOR_3 y_vector
        )
    {
    ...
    VOID SetZVector(
        const REAL_64_VECTOR_3 z_vector
        )
    {
    ...
    VOID SetWVector(
        const REAL_64_VECTOR_3 w_vector
        )
    {
    ...
    VOID SetProductMatrix(
        const REAL_64_MATRIX_16 & first_matrix,
        const REAL_64_MATRIX_16 & second_matrix
        )
    {
        ...
        )
    {
        ...
        if ( !REAL_64_IsRoughlyZero( x_angle ) )
        {
        ...
        )
    {
        ...
        if ( !REAL_64_IsRoughlyZero( y_angle ) )
        {
        ...
        )
    {
        ...
        if ( !REAL_64_IsRoughlyZero( z_angle ) )
        {
