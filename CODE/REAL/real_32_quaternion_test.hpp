...
struct REAL_32_QUATERNION_TEST
{
    // == PUBLIC
    ...
    static VOID CheckAngles(
        const REAL_32_QUATERNION & quaternion,
        const REAL_32_QUATERNION & angle_quaternion,
        const _MATRIX_ & matrix,
        ...
        NATIVE_ForEachIntervalIndex( x_angle_index, first_angle_index, last_angle_index )
        {
            ...
            NATIVE_ForEachIntervalIndex( y_angle_index, first_angle_index, last_angle_index )
            {
                ...
                NATIVE_ForEachIntervalIndex( z_angle_index, first_angle_index, last_angle_index )
                {
                    ...
                    REAL_32_DumpAngle( y_angle );
                    REAL_32_DumpAngle( z_angle );
                    REAL_32_DumpAngle( quaternion_x_angle );
                    REAL_32_DumpAngle( quaternion_y_angle );
                    REAL_32_DumpAngle( quaternion_z_angle );
                    REAL_32_DumpAngle( matrix_x_angle );
                    REAL_32_DumpAngle( matrix_y_angle );
                    REAL_32_DumpAngle( matrix_z_angle );
        ...
        )
    {
        ...
        CheckAngles<REAL_32_MATRIX_9>( first_angle_index, last_angle_index, angle_step );
        CheckProduct<REAL_32_MATRIX_9>( first_angle_index, last_angle_index, angle_step );
        CheckProduct<REAL_32_MATRIX_12>( first_angle_index, last_angle_index, angle_step );
        CheckProduct<REAL_32_MATRIX_16>( first_angle_index, last_angle_index, angle_step );
    }
};
